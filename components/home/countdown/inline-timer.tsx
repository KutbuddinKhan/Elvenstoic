...
export default function InlineTimer() {
    ...
    useEffect(() => {
        ...
        // const startDate = new Date('2025-05-28T00:10:00+02:00');
        // End date: Saturday, May 31st, 2025 at 5pm CET  
        // const endDate = new Date('2025-05-28T12:00:00+02:00');

        const startDate = new Date('2025-05-27T20:45:00+02:00'); // 8:45 PM CEST
        const endDate = new Date('2025-05-28T12:00:00+02:00');   // 12:00 PM CEST
