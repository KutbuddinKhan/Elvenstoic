...
export default function CollaborationsPage() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // GSAP animation for the collaborations page
      const tl = gsap.timeline()

      tl.fromTo(".collab-title", { opacity: 0, y: 30 }, { opacity: 1, y: 0, duration: 0.8, ease: "power3.out" })
        .fromTo(
          ".collab-subtitle",
          { opacity: 0, y: 20 },
    ...
    <section ref={sectionRef} className="pt-16 bg-slate-950 relative overflow-hidden min-h-screen">
      ...
      <div className="container relative z-10 px-4 md:px-6">
        ...
        <div className="flex flex-col items-center justify-center py-12 md:py-24 lg:py-32 text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-blue-900/30 border border-blue-800/50 backdrop-blur-sm px-4 py-1.5 text-sm mb-4 collab-title">
            <Users className="h-4 w-4 fill-blue-500 text-gradient" />
            <span>Partnering with industry leaders</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto pb-24">
          {/* Background effects for masonry section - matching FanWallPage */}
                        ...
                        <div className="relative rounded-lg overflow-hidden">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/50 opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end">
                            <div className="p-4 text-white">
                              <p className="font-medium">Collaboration #{index + 1}</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="rounded-xl overflow-hidden bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 p-2">
                <div className="relative rounded-lg overflow-hidden">
                  <Image
                    ...
                    alt={`Collaboration ${selectedImage + 1}`}
                    width={1200}
                    height={1200}
